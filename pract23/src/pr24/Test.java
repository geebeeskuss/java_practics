...
public class Test {
    public static void main(String[] args) {
        ...
        orders[4].add(new Dish(287,"Plate", "Now time to check this"));
        orders[3].add(new Drink(30,"Cup", "It's just for tea"));
        orders[2].add(new Drink(38,"Cup", "It's just for tea"));
        orderManager.add(orders[3], 7);
        orderManager.add(orders[4], 6);
        orderManager.add(orders[3],2);
        //orderManager.add(orders[4],2);
        //orderManager.add(orders[3],-2);
